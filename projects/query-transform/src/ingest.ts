...
/**
 * Main ingestion pipeline for the query-transform RAG system.
 *
 * This function reuses the standard ingestion pipeline from basic-rag.
 * No special ingestion requirements are needed for query transformations,
 * as the transformations are applied at query time, not during ingestion.
 *
